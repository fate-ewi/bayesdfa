# Part of the rstanarm package for estimating model parameters Copyright (C) 2015, 2016 Trustees of
# Columbia University This program is free software; you can redistribute it and/or modify it under the
...
# This file is only intended to be used during the installation process nocov start
...
stanmodels <- sapply(stan_files, function(f) {
    ...
    return(do.call(methods::new, args = c(stanfit[-(1:3)], Class = "stanmodel", mk_cppmodule = function(x) get(paste0("model_", 
        model_cppname)))))
})
