...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(682, 680, "end", "model_dfa");
    return reader;
}
            ...
            if (as_bool(logical_eq(est_cor, 0))) {
                ...
                if (as_bool(logical_eq(long_format, 0))) {
                    ...
                    if (as_bool(logical_eq(obs_model, 1))) {
                        ...
                        for (int i = 1; i <= n_pos; ++i) {
                            current_statement_begin__ = 578;
                            lp_accum__.add(normal_log(get_base1(y, i, "y", 1), ((get_base1(offset, i, "offset", 1) + get_base1(pred, get_base1(row_indx_pos, i, "row_indx_pos", 1), get_base1(col_indx_pos, i, "col_indx_pos", 1), "pred", 1)) + get_base1(obs_cov_offset, i, "obs_cov_offset", 1)), get_base1(sigma_vec, get_base1(row_indx_pos, i, "row_indx_pos", 1), "sigma_vec", 1)));
                        }
                    }
                ...
                if (as_bool(logical_eq(long_format, 0))) {
                    ...
                    if (as_bool(logical_eq(obs_model, 1))) {
                        ...
                        for (int i = 1; i <= n_pos; ++i) {
                            ...
                            stan::model::assign(log_lik, 
                                        stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                                        normal_log(get_base1(y, i, "y", 1), ((get_base1(offset, i, "offset", 1) + get_base1(pred, get_base1(row_indx_pos, i, "row_indx_pos", 1), get_base1(col_indx_pos, i, "col_indx_pos", 1), "pred", 1)) + get_base1(obs_cov_offset, i, "obs_cov_offset", 1)), get_base1(sigma_vec, get_base1(row_indx_pos, i, "row_indx_pos", 1), "sigma_vec", 1)), 
                                        "assigning variable log_lik");
                        }
                    }
