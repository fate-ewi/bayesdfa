...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(638, 636, "end", "model_dfa");
    return reader;
}
...
public:
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        try {
            ...
            validate_non_negative_index("distKnots", "n_knots", n_knots);
            validate_non_negative_index("distKnots", "n_knots", n_knots);
            context__.validate_dims("data initialization", "distKnots", "matrix_d", context__.to_vec(n_knots,n_knots));
            distKnots = Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>(n_knots, n_knots);
            vals_r__ = context__.vals_r("distKnots");
            pos__ = 0;
            size_t distKnots_j_2_max__ = n_knots;
            size_t distKnots_j_1_max__ = n_knots;
            ...
            validate_non_negative_index("distKnots21", "N", N);
            validate_non_negative_index("distKnots21", "n_knots", n_knots);
            context__.validate_dims("data initialization", "distKnots21", "matrix_d", context__.to_vec(N,n_knots));
            distKnots21 = Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>(N, n_knots);
            vals_r__ = context__.vals_r("distKnots21");
            pos__ = 0;
            size_t distKnots21_j_2_max__ = n_knots;
            size_t distKnots21_j_1_max__ = N;
                    ...
                    for (int k = 1; k <= K; ++k) {
                        ...
                        for (int i = 1; i <= n_knots; ++i) {
                            ...
                            stan::model::assign(SigmaKnots, 
                                        ...
                                        (get_base1(SigmaKnots, i, i, "SigmaKnots", 1) + 0.00001), 
            ...
            if (as_bool(logical_eq(est_cor, 0))) {
                ...
                if (as_bool(logical_eq(long_format, 0))) {
                    ...
                    if (as_bool(logical_eq(obs_model, 3))) {
                        ...
                        for (int i = 1; i <= n_pos; ++i) {
                            current_statement_begin__ = 528;
                            lp_accum__.add(poisson_log_log(get_base1(y_int, i, "y_int", 1), get_base1(pred, get_base1(row_indx_pos, i, "row_indx_pos", 1), get_base1(col_indx_pos, i, "col_indx_pos", 1), "pred", 1)));
                        }
                    }
                    ...
                    if (as_bool(logical_eq(obs_model, 4))) {
                        ...
                        for (int i = 1; i <= n_pos; ++i) {
                            current_statement_begin__ = 529;
                            lp_accum__.add(neg_binomial_2_log_log(get_base1(y_int, i, "y_int", 1), get_base1(pred, get_base1(row_indx_pos, i, "row_indx_pos", 1), get_base1(col_indx_pos, i, "col_indx_pos", 1), "pred", 1), get_base1(nb_phi_vec, get_base1(row_indx_pos, i, "row_indx_pos", 1), "nb_phi_vec", 1)));
                        }
                    }
                    ...
                    if (as_bool(logical_eq(obs_model, 5))) {
                        ...
                        for (int i = 1; i <= n_pos; ++i) {
                            current_statement_begin__ = 530;
                            lp_accum__.add(bernoulli_logit_log(get_base1(y_int, i, "y_int", 1), get_base1(pred, get_base1(row_indx_pos, i, "row_indx_pos", 1), get_base1(col_indx_pos, i, "col_indx_pos", 1), "pred", 1)));
                        }
                    }
                    ...
                    if (as_bool(logical_eq(obs_model, 6))) {
                        ...
                        for (int i = 1; i <= n_pos; ++i) {
                            current_statement_begin__ = 531;
                            lp_accum__.add(lognormal_log(get_base1(y, i, "y", 1), get_base1(pred, get_base1(row_indx_pos, i, "row_indx_pos", 1), get_base1(col_indx_pos, i, "col_indx_pos", 1), "pred", 1), get_base1(sigma_vec, get_base1(row_indx_pos, i, "row_indx_pos", 1), "sigma_vec", 1)));
                        }
                    }
                }
            } else {
                ...
                if (as_bool(logical_eq(long_format, 0))) {
                    ...
                    if (as_bool(logical_eq(obs_model, 2))) {
                        ...
                        for (int i = 1; i <= n_pos; ++i) {
                            ...
                            stan::model::assign(log_lik, 
                                        stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                                        gamma_log(get_base1(y, i, "y", 1), get_base1(gamma_a_vec, get_base1(row_indx_pos, i, "row_indx_pos", 1), "gamma_a_vec", 1), (get_base1(gamma_a_vec, get_base1(row_indx_pos, i, "row_indx_pos", 1), "gamma_a_vec", 1) / stan::math::exp(get_base1(pred, get_base1(row_indx_pos, i, "row_indx_pos", 1), get_base1(col_indx_pos, i, "col_indx_pos", 1), "pred", 1)))), 
                                        "assigning variable log_lik");
                        }
                    }
                    ...
                    if (as_bool(logical_eq(obs_model, 3))) {
                        ...
                        for (int i = 1; i <= n_pos; ++i) {
                            ...
                            stan::model::assign(log_lik, 
                                        stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                                        poisson_log_log(get_base1(y_int, i, "y_int", 1), get_base1(pred, get_base1(row_indx_pos, i, "row_indx_pos", 1), get_base1(col_indx_pos, i, "col_indx_pos", 1), "pred", 1)), 
                                        "assigning variable log_lik");
                        }
                    }
                    ...
                    if (as_bool(logical_eq(obs_model, 4))) {
                        ...
                        for (int i = 1; i <= n_pos; ++i) {
                            ...
                            stan::model::assign(log_lik, 
                                        stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                                        neg_binomial_2_log_log(get_base1(y_int, i, "y_int", 1), get_base1(pred, get_base1(row_indx_pos, i, "row_indx_pos", 1), get_base1(col_indx_pos, i, "col_indx_pos", 1), "pred", 1), get_base1(nb_phi_vec, get_base1(row_indx_pos, i, "row_indx_pos", 1), "nb_phi_vec", 1)), 
                                        "assigning variable log_lik");
                        }
                    }
                    ...
                    if (as_bool(logical_eq(obs_model, 5))) {
                        ...
                        for (int i = 1; i <= n_pos; ++i) {
                            ...
                            stan::model::assign(log_lik, 
                                        stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                                        bernoulli_logit_log(get_base1(y_int, i, "y_int", 1), get_base1(pred, get_base1(row_indx_pos, i, "row_indx_pos", 1), get_base1(col_indx_pos, i, "col_indx_pos", 1), "pred", 1)), 
                                        "assigning variable log_lik");
                        }
                    }
                    ...
                    if (as_bool(logical_eq(obs_model, 6))) {
                        ...
                        for (int i = 1; i <= n_pos; ++i) {
                            ...
                            stan::model::assign(log_lik, 
                                        stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                                        lognormal_log(get_base1(y, i, "y", 1), get_base1(pred, get_base1(row_indx_pos, i, "row_indx_pos", 1), get_base1(col_indx_pos, i, "col_indx_pos", 1), "pred", 1), get_base1(sigma_vec, get_base1(row_indx_pos, i, "row_indx_pos", 1), "sigma_vec", 1)), 
                                        "assigning variable log_lik");
                        }
                    }
                }
