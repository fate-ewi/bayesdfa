...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(639, 637, "end", "model_dfa");
    return reader;
}
            ...
            if (as_bool(logical_eq(proportional_model, 0))) {
                ...
                if (as_bool(logical_eq(est_gp, 1))) {
                    ...
                    for (int k = 1; k <= K; ++k) {
                        ...
                        stan::math::assign(SigmaOffDiagTemp, multiply(square(get_base1(sigma_pro, k, "sigma_pro", 1)), stan::math::exp(divide(minus(distKnots21), (2.0 * pow(get_base1(gp_theta, k, "gp_theta", 1), 2.0))))));
