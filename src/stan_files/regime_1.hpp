...
class model_regime_1
  : public stan::model::model_base_crtp<model_regime_1> {
private:
        int T;
        int K;
...
public:
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            std::vector<local_scalar_t__> sigmas(T, local_scalar_t__(0));
            ...
            current_statement_begin__ = 13;
            size_t sigmas_k_0_max__ = T;
            for (size_t k_0__ = 0; k_0__ < sigmas_k_0_max__; ++k_0__) {
                if (stan::math::is_uninitialized(sigmas[k_0__])) {
                    std::stringstream msg__;
                    msg__ << "Undefined transformed parameter: sigmas" << "[" << k_0__ << "]";
    ...
    void write_array(RNG& base_rng__,
        ...
        try {
            ...
            current_statement_begin__ = 13;
            validate_non_negative_index("sigmas", "T", T);
            std::vector<double> sigmas(T, double(0));
            stan::math::initialize(sigmas, DUMMY_VAR__);
            stan::math::fill(sigmas, DUMMY_VAR__);
    ...
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        if (include_tparams__) {
            ...
            for (size_t k_0__ = 0; k_0__ < sigmas_k_0_max__; ++k_0__) {
                param_name_stream__.str(std::string());
                param_name_stream__ << "sigmas" << '.' << k_0__ + 1;
                param_names__.push_back(param_name_stream__.str());
            }
        }
